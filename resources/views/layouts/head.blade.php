<head>
    ...
    <!-- Plugins css start-->
   @yield('css')
    <link rel="stylesheet" type="text/css" href='{{url("/panel/assets/css/prism.css")}}'>
    <link rel="stylesheet" type="text/css" href='{{url("/panel/assets/css/vertical-menu.css")}}'>
    <!-- Plugins css Ends-->
    <!-- Bootstrap css-->
